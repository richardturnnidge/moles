...
defineSprites:
							;  make mole sprites
							; MAKE_SPRITE spriteNum, bitmapNum
...
hideSprites:
	...
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +1	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +2	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +3	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +4	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +5	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +6	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE moleSprite +7	; 0
	HIDE_CURRENT_SPRITE
	SELECT_SPRITE spadeSprite 	; 0
	HIDE_CURRENT_SPRITE
